...
const Room302:NextPage = () => {
    return(
        <Layout>
            <div className={styles.roompagewrap}>
                <RoomHeader h2title={'ROOM 302'} imgsrc={'/sub/302_img01.jpg'} />
                <RoomHeaderInfo roomtitle={'ROOM 302'} pricetitle={'100,000원 ~ 130,000원'} roominfo1={'일반객실,기준 2인 (최대 4인), 남녀공용'} roominfo2={'방1, 침대1, 욕실1'} imgsrc={'/sub/302_img02.jpg'} />
                <RoomInfomation
                        ...
                        <Row className={'gy-4'}>
                            <Col xl={6} xs={12}>
                                <div className={styles.imgbox}>
                                    <Image src={'/sub/302_img03.jpg'} alt={'sub-img'} />
                                </div>
                            </Col>
                            <Col xl={6} xs={12}>
                                <div className={styles.imgbox}>
                                    <Image src={'/sub/302_img04.jpg'} alt={'sub-img'} />
                                </div>
                            </Col>
                            <Col xl={6} xs={12}>
                                <div className={styles.imgbox}>
                                    <Image src={'/sub/302_img05.jpg'} alt={'sub-img'} />
                                </div>
                            </Col>
                            <Col xl={6} xs={12}>
                                <div className={styles.imgbox}>
                                    <Image src={'/sub/302_img06.jpg'} alt={'sub-img'} />
                                </div>
                            </Col>
                        </Row>
                    </Container>
